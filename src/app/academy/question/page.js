...
export default function Question() {
    ...
    const prompt_type = 'question'
    const { fetchRoomName, roomName, SendChatData, startSocketConnection } = useContext(ChatContext)
