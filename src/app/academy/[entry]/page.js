        ...
        <div className="h-screen flex flex-col pb-6">
            <div className="h-full flex flex-col justify-center">
                ...
                <form onSubmit={(e) => { (SendChatData(e, prompt_type)) }} className="mt-10 max-w-2xl w-full mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {!chatData.loading ?
                        <button type="submit" className="py-3 px-4  flex  mt-2 w-full text-center items-center justify-center gap-x-2 text-sm font-medium rounded-full border border-transparent bg-gray-800 text-white hover:bg-gray-900 focus:outline-hidden focus:bg-gray-900 disabled:opacity-50  dark:bg-gray-800 dark:text-neutral-200">
                            Send
