            ...
            <div className="min-h-[100vh] w-full flex md:flex-row justify-center items-center">
              <div className=" md:mx-20 mt-0 md:w-[50%] flex flex-col justify-center  ">
                ...
                <motion.div
                  ...
                  <Link
                    href={"/auth/login"}
                    className="w-60 transform rounded-lg max-sm:mx-auto  bg-[#001219] px-6 py-2 font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#001219] dark:bg-[#001219] dark:text-white dark:hover:bg-gray-700">
                    Get Started
                  </Link>
