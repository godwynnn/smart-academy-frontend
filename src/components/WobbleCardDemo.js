...
export function WobbleCardDemo() {
  return (
    <div
      className="grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-7xl mx-auto w-full pt-[25%]  section" data-color='white'>
      <WobbleCard
        containerClassName="col-span-1 lg:col-span-2 h-full bg-[#212529] min-h-[500px] lg:min-h-[300px]"
        className="">
      ...
      <WobbleCard
        containerClassName="col-span-1 lg:col-span-3 bg-[#001233] min-h-[500px] lg:min-h-[600px] xl:min-h-[300px]">
